...
public class FileSystemStorageService implements StorageService {
	...
	@Autowired
	public FileSystemStorageService(Image properties) {
		this.rootLocation = Paths.get(properties.getLocation());
	}

	public void store(MultipartFile file2) {
		...
		user.setUserimage(file2.getOriginalFilename().toString());
